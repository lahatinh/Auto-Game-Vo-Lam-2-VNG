...
namespace AutoClient.Entities
{
    public class PlayerEntity
    {
        ...
        public int CheckLT
        {
            get
            {
                return WinAPI.ReadProcessMemoryInt32(Client.OpenProcessHandle, IntPtr.Add(GameConst.CheckBaseLatThe, 0x0));
        ...
        public bool IsOnHorse //đang sử dụng ngựa
        {
            get
            {
                return WinAPI.ReadProcessMemoryInt32(Client.OpenProcessHandle, IntPtr.Add(Address, 0x4a0)) == 8;
            }
        }
        ...
        public int HoanthanhNVTNC
        {
            get
            {
                return WinAPI.ReadProcessMemoryInt32(Client.OpenProcessHandle, IntPtr.Add(Address, 0x0));
            }
        }
    }
}
